...
# creating a couple of handy features 
...
# 5. Linear Regression (Supervised): Predicting Average Likes from Followers         (scatter graph)
x = df[["Followers"]]
y = df["Average Likes"]
...
# 6. KMeans (Unsupervised): Cluster on Followers & Engagement Rate              (scatter graph)
